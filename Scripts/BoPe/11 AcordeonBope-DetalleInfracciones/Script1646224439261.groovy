...
WebUI.setText(findTestObject('URL/Formulario BoPe/SET_nombre'), 'Patricio')
...
WebUI.setText(findTestObject('URL/Formulario BoPe/SET_numeroDOC'), '24546789')
...
WebUI.waitForElementVisible(findTestObject('URL/Formulario BoPe/BOTON_detalleInfracciones'), 3)

WebUI.click(findTestObject('URL/Formulario BoPe/BOTON_detalleInfracciones'))
...
WebUI.takeScreenshot('C:\\Users\\Andres Torrealba\\OneDrive\\Escritorio\\KEYLAB\\EVIDENCIA\\11.0SC-AcordeonBope-DetalleInfracciones.png')
