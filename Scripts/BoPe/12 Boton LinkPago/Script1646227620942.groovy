...
WebUI.click(findTestObject('URL/Formulario BoPe/BOTON_LinkPago'))

WebUI.delay(2)

SC = WebUI.takeScreenshot()

WebUI.takeScreenshot('C:\\Users\\Andres Torrealba\\OneDrive\\Escritorio\\KEYLAB\\EVIDENCIA\\12SC-Boton-LinkPago.png')
