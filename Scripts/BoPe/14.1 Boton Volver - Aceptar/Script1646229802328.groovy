...
WebUI.click(findTestObject('URL/Formulario BoPe/BOTON_ACEPTAR'))

SC = WebUI.takeScreenshot()

WebUI.takeScreenshot('C:\\Users\\Andres Torrealba\\OneDrive\\Escritorio\\KEYLAB\\EVIDENCIA\\14.1SC-Boton-Volver-Aceptar.png')
