...
WebUI.setText(findTestObject('URL/Formulario BoPe/SET_nombre'), 'Valeria')

WebUI.setText(findTestObject('URL/Formulario BoPe/SET_apellidos'), 'Martinez')
...
WebUI.setText(findTestObject('URL/Formulario BoPe/SET_numeroDOC'), '34343aa2')
...
WebUI.takeScreenshot('C:\\Users\\Andres Torrealba\\OneDrive\\Escritorio\\KEYLAB\\EVIDENCIA\\7.1SC-TipoDocDNI-CS.png')
